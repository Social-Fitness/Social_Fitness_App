          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("Benvenuto",
                  style: TextStyle(color: Colors.white, fontSize: 50),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("I campioni non si fanno nelle palestre. I campioni si fanno con qualcosa che hanno nel loro profondo: un desiderio, un sogno, una visione.",
