...
class RichiestaCiclismo extends StatefulWidget {
  String email;
  Utente utente;
  RichiestaCiclismo({Key key, this.email, this.utente}) : super(key: key);
  @override
  RichiestaCiclismoState createState() => RichiestaCiclismoState(email:email, utente: utente);
}

class RichiestaCiclismoState extends State<RichiestaCiclismo> {
  String email;
  Utente utente;
  RichiestaCiclismoState ({Key key, this.email, this.utente});
