...
class Richiesta extends StatefulWidget {
  String sport;
  String email;
  Utente utente;
  Richiesta({Key key, this.sport, this.email, this.utente}) : super(key: key);
  @override
  RichiestaState createState() => RichiestaState(sport:sport, email:email, utente: utente);
}

class RichiestaState extends State<Richiesta> {
  String sport;
  String email;
  Utente utente;
  RichiestaState ({Key key, this.sport, this.email, this.utente});
    ...
    firestoreInstance.collection("richiesta_scheda").add(
        {
          ...
          "Disponibilita_settimanale": _DisponibilitaController,
