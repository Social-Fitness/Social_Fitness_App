            ...
            if (i == 2) {
              ...
              if(pw.compareTo(_passwordController.text)==0) {
                if(categoriaDB.compareTo("Sportivo")==0) {
                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => homePageSP(utente: utente)), (Route<dynamic> route) => false);
                }
                else {
                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => homePagePT(utente: utente)), (Route<dynamic> route) => false);
                }
              }
              else {
                _showMyDialog();
